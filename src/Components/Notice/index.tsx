export default function SvgComponent(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 1504.89" {...props}>
      <defs>
        <style>
          {
            '.Notice__cls-3{fill:#b5ce97}.Notice__cls-3,.Notice__cls-4,.Notice__cls-5,.Notice__cls-9{stroke:#326e4c}.Notice__cls-14,.Notice__cls-3,.Notice__cls-4,.Notice__cls-5,.Notice__cls-6,.Notice__cls-9{stroke-miterlimit:10}.Notice__cls-3,.Notice__cls-4,.Notice__cls-5,.Notice__cls-6{stroke-width:1.2px}.Notice__cls-4{fill:#f7c9dd}.Notice__cls-14,.Notice__cls-5,.Notice__cls-6{fill:none}.Notice__cls-6{stroke:#3fa066}.Notice__cls-7{font-size:28.67px}.Notice__cls-10,.Notice__cls-7{fill:#326e4c;font-family:NanumMyeongjo,Nanum Myeongjo}.Notice__cls-8,.Notice__cls-9{font-size:35.99px}.Notice__cls-8{font-family:NanumMyeongjoBold,Nanum Myeongjo}.Notice__cls-9{stroke-width:.3px;letter-spacing:0}.Notice__cls-10{font-size:34.3px;letter-spacing:-.1em}.Notice__cls-14{stroke:#1e603f;stroke-width:.41px}'
          }
        </style>
      </defs>
      <g id="Notice__\uB808\uC774\uC5B4_2" data-name="\uB808\uC774\uC5B4 2">
        <g id="Notice__Layer_1" data-name="Layer 1">
          ...
          <text className="Notice__cls-7" transform="translate(425.56 1160.21)">
            {'\uC758 \uC7A5\uB0A8'}
            <tspan className="Notice__cls-8" x={90.33} y={0} />
          ...
          <text transform="translate(168.32 804.78)" fontFamily="NanumMyeongjo" fontSize={25} fill="#443d39" letterSpacing="-.01em">
            {'\uCF54\uB85C\uB09819\uB85C \uC5B4\uB824\uC6B4 \uC2DC\uAD6D\uC5D0 \uCCAD\uCCA9\uC7A5 \uC804\uB2EC\uC774'}
            <tspan x={8.69} y={46.01}>
              {'\uB9C8\uC74C\uC758 \uC9D0\uC774 \uB418\uC9C0 \uC54A\uC744\uAE4C \uAC71\uC815\uC774 \uB429\uB2C8\uB2E4.'}
            </tspan>
            <tspan x={-16.5} y={92.02}>
              {'\uCC38\uC11D\uC774 \uC5B4\uB824\uC6B0\uC2DC\uB354\uB77C\uB3C4 \uBA40\uB9AC\uC11C \uCD95\uD558\uD574\uC8FC\uC2DC\uBA74'}
            </tspan>
            <tspan x={95.13} y={138.03}>
              {'\uB9C8\uC74C \uAC10\uC0AC\uD788 \uBC1B\uACA0\uC2B5\uB2C8\uB2E4.'}
            </tspan>
          </text>
          <text
            transform="translate(283.58 271.58)"
            fontSize={40}
            fill="#ad7e5e"
          ...
          <text
            transform="translate(219.81 397.41)"
            fontSize={26.3}
            strokeWidth={0.2}
            letterSpacing="-.01em"
          ...
          >
            {'\uB2A6\uC740 \uAC00\uC744\uC5D0 \uCC98\uC74C \uB9CC\uB09C \uB450 \uC0AC\uB78C,'}
            <tspan x={-87.08} y={60.32}>
              {'\uB450 \uD574\uB97C \uAC70\uCCD0 \uBD80\uBD80\uB85C\uC11C \uB610 \uB2E4\uB978 \uC2DC\uC791\uC744 \uD569\uB2C8\uB2E4.'}
            </tspan>
            <tspan x={-13.5} y={120.65}>
              {'\uC11C\uB85C \uB2EE\uC740 \uB4EF \uB2E4\uB978 \uC800\uD76C \uB450 \uC0AC\uB78C\uC774'}
            </tspan>
            <tspan x={11.74} y={180.97}>
              {'\uC11C\uB85C\uC758 \uBD80\uC871\uD55C \uC810\uC744 \uCC44\uC6CC\uC8FC\uBA70'}
            </tspan>
            <tspan x={7.67} y={241.3}>
              {'\uD589\uBCF5\uD55C \uAC00\uC815\uC744 \uC774\uB8F0 \uC218 \uC788\uB3C4\uB85D'}
            </tspan>
            <tspan x={-44.74} y={301.62}>
              {'\uC624\uC154\uC11C \uCD95\uBCF5\uD574 \uC8FC\uC2DC\uBA74 \uAC10\uC0AC\uD558\uACA0\uC2B5\uB2C8\uB2E4.'}
            </tspan>
          </text>
        </g>
