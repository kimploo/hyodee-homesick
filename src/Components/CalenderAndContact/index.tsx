...
import { changeLocation } from '../../reducer/contactButton';
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox={`0 0 ${width} 1920.86`} {...props}>
      <defs>
        <style>
          {`
            ...
            .CalendarAndContact-cls-hiddenButton {
              fill: #FFFFFF;
            }
          `}
        </style>
      ...
      <g id="\uB808\uC774\uC5B4_2" data-name="\uB808\uC774\uC5B4 2">
        ...
        <a id="groomPhone" href={`tel://${groom.phone}`}>
          <rect className="CalendarAndContact-cls-hiddenButton" opacity={0} x={x} y={y} width={btnWidth} height={btnHeight} />
          <path
        ...
        <a id="groomMessage" href={`sms://${groom.phone}&body=신랑 ${groom.personName}님의 ${celebrationMessage}`}>
          ...
          <rect className="CalendarAndContact-cls-hiddenButton" opacity={0} x={x + phoneMsg} y={y} width={btnWidth} height={btnHeight} />
        </a>
        <a id="bridePhone" href={`tel://${bride.phone}`}>
          ...
          <rect className="CalendarAndContact-cls-hiddenButton" opacity={0} x={x + between} y={y} width={btnWidth} height={btnHeight} />
        </a>
        ...
        <a id="groomFatherPhone" href={`tel://${groomFather.phone}`}>
          ...
          <rect className="CalendarAndContact-cls-hiddenButton" opacity={0} x={x} y={y + 420} width={btnWidth} height={btnHeight} />
        </a>
